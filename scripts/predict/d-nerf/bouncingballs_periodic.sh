...
max_time=1.0  # used to split transforms_train.json
time_freq=6
nearest_num=6
feature_amplify=0.5
...
source_path="./datasets/d-nerf/data/${scene_name}_periodic/"

CUDA_VISIBLE_DEVICES=1 python train_GCN.py  -s $source_path -m $model_path --max_points $max_keypoints \
